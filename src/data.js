...
const ISSUES = [
 ...
 {n:9,title:'엔드게임',env:'황혼의 최종 전장',need:80,bosses:['타노스 • 파워 스톤','타노스 • 스페이스 스톤','타노스 • 리얼리티 스톤','타노스 • 소울 스톤','타노스 • 타임 스톤','타노스 • 인피니티'],gimmick:'6번의 전투마다 스톤과 기술이 누적된다. 최종전에서는 한 번의 핑거 스냅 — 안전 차선으로!',intro:'파워부터 마인드까지. 타노스는 전투를 거듭하며 여섯 스톤을 완성한다. 이전 스톤의 기술도 다시 사용하므로 예고를 읽고 대응하라.'},
];
