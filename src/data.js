...
const ISSUES = [
 {n:1,title:'고블린의 밤',env:'맨해튼 옥상',need:1,bosses:['골드 고블린','메너스','그레이 고블린','그린 고블린','하우스 오브 M 고블린'],gimmick:'녹색 가스 장애물을 설치한다',
  intro:'닉 퓨리가 접선한다. 골드 고블린이 차원 포털을 열어 다중우주의 시니스터 식스를 불러들이고 ISO-8을 노린다. S.H.I.E.L.D.는 같은 포털로 다른 차원의 스파이더들을 소환하기로 한다.'},
 {n:2,title:'하늘의 사냥꾼',env:'하이라인·오스코프 타워',need:10,bosses:['벌처','클래식 벌처','얼티밋 벌처','레드 벌처','다크 벌처'],gimmick:'칼날 날개 장애물 — 부딪히면 빙글 돌며 튕겨난다(즉사 아님)',
  intro:'벌처의 차원 변종들이 뉴욕 상공을 장악한다. 스윙과 자유낙하로 추격하라.'},
 {n:3,title:'고압 전류 주의!',env:'전력망·지하철',env2:'전력망',need:20,bosses:['일렉트로','클래식 일렉트로','퓨어 에너지 일렉트로','얼티밋 일렉트로','모던 일렉트로'],gimmick:'푸른 번개 장애물을 설치한다',
  intro:'일렉트로 변종들이 도시 전력을 흡수한다. 무장병의 사격을 피하며 SHIELD 폭탄을 던져라.'},
 {n:4,title:'흩날리는 적',env:'공사장·해변',need:30,bosses:['샌드맨','클래식 샌드맨','퓨어 샌드맨','얼티밋 샌드맨','샌드맨 느와르','다크 샌드맨'],gimmick:'모래기둥에 둘러싸여 있고, 불투명한 모래 장애물이 시야를 가린다',
  intro:'샌드맨 변종들이 도시를 모래로 삼킨다. 벽타기 구간에 주의.'},
 {n:5,title:'위험천만한 박사!',env:'옥토퍼스 거대 기계',need:40,bosses:['챕터 1 닥터 옥토퍼스','클래식 닥터 옥토퍼스','닥터 옥토퍼스 느와르','얼티밋 닥터 옥토퍼스','닥터 옥토퍼스'],gimmick:'문어다리 장애물 — 부딪히면 빙글 돌며 튕겨난다(즉사 아님)',
  intro:'닥터 옥토퍼스의 거대 기계 위를 달린다. 장갑병은 슬라이드로만 쓰러뜨릴 수 있다.'},
 {n:6,title:'미스테리오의 난동!',env:'시니스터 식스 우주선',need:50,bosses:['클래식 미스테리오','다크 미스테리오','미스테리온','슈페리어 미스테리온','미스테리오'],gimmick:'장갑·눈 장식 장애물. 자기 공간에서 거대화하며, 쉴드를 공격해야 데미지가 들어간다',
  intro:'시니스터 식스의 우주선. 미스테리오의 환영이 차선을 뒤흔든다.'},
 {n:7,title:'에이지 오브 울트론',env:'울트론 점령 도시',need:60,bosses:['울트론 MK.1','울트론(코믹스)','울트론 프라임','얼티밋 울트론'],
 ...
 {n:8,title:'홈커밍',env:'퀸스 · 폐기물 회수 창고',need:70,bosses:['쇼커','모던 벌쳐'],gimmick:'진동 건틀릿과 터빈 날개. 쇼커의 충격파는 점프, 벌쳐의 저공 비행은 슬라이드!',intro:'퀸스의 회수 창고에서 외계 기술이 무기로 바뀌고 있다. 쇼커를 돌파하고 하늘을 장악한 모던 벌쳐를 저지하라.'},
 {n:9,title:'인피니티 워',env:'침공당한 뉴욕 · Q-쉽',need:70,bosses:['프록시마 미드나이트','콜버스 글레이브','컬 옵시디언','에보니 모','타노스(미완)'],gimmick:'블랙 오더와 스톤 없는 타노스. 예고를 피하고 쉴드를 웹 공격하라.',intro:'도시 상공에 Q-쉽이 나타났다. 네 명의 침략자를 돌파하면 인피니티 스톤을 갖기 전의 타노스가 기다린다.'},
 {n:10,title:'엔드게임',env:'황혼의 최종 전장',need:80,bosses:['타노스 • 파워 스톤','타노스 • 스페이스 스톤','타노스 • 리얼리티 스톤','타노스 • 소울 스톤','타노스 • 타임 스톤','타노스 • 인피니티'],gimmick:'6번의 전투마다 스톤과 기술이 누적된다. 최종전에서는 한 번의 핑거 스냅 — 안전 차선으로!',intro:'파워부터 마인드까지. 타노스는 전투를 거듭하며 여섯 스톤을 완성한다. 이전 스톤의 기술도 다시 사용하므로 예고를 읽고 대응하라.'},
 {n:11,title:'파 프롬 홈',env:'유럽 운하 · 런던 타워 브리지',need:100,bosses:['샌드맨(엘리멘탈스)','사이클론(엘리멘탈스)','하이드로맨(엘리멘탈스)','몰튼맨(엘리멘탈스)','엘리멘탈스 퓨전'],gimmick:'모래·바람·물·불의 거인. 퓨전 격파 직후 미스테리오(파 프롬 홈) 연속전!',intro:'유럽 곳곳에 나타난 엘리멘탈스를 추적하라. 런던에서 거대한 퓨전이 무너져도 전투는 끝나지 않는다. 환영 뒤에 숨은 드론과 미스테리오를 저지해야 한다.'},
 {n:12,title:'노 웨이 홈',env:'자유의 여신상 · 다중우주 균열',need:110,bosses:['닥터 옥토퍼스(노 웨이 홈)','그린 고블린(노 웨이 홈)','샌드맨(노 웨이 홈)','리자드(노 웨이 홈)','일렉트로(노 웨이 홈)','노 웨이 홈 · 최종 결전'],gimmick:'개인전 5회 뒤 다섯 보스가 동시에 등장. 최종전은 한 명분의 체력을 공유한다.',intro:'다중우주에서 넘어온 다섯 적이 자유의 여신상에 모였다. 촉수, 폭탄, 모래, 꼬리와 번개를 돌파하라. 마지막에는 전원이 함께 맞선다.'},
 {n:13,title:'브랜드 뉴 데이',env:'뉴욕 재개발 지구 · 염동력 폭풍',need:120,bosses:['스콜피온','툼스톤','부메랑','진 그레이'],gimmick:'기계 꼬리, 강철 같은 주먹, 돌아오는 부메랑. 마지막은 헐크와 퍼니셔를 조종하는 진 그레이!',intro:'새로운 위협이 뉴욕을 뒤흔든다. 네 명의 보스를 돌파하고 염동력으로 떠오른 잔해 사이에서 진 그레이의 정신 지배를 저지하라.'},
 {n:14,title:'캉 다이너스티',env:'크로노폴리스 · 시간의 성채',need:130,bosses:['빅터 타임리','라마투트','스칼렛 센추리온','이모터스','정복자 캉'],gimmick:'다섯 시간 변형체. 발명품, 광선, 중장갑, 시간 반복을 넘어 정복자 캉에게 도전!',intro:'서로 다른 시대의 캉들이 시간의 성채를 지킨다. 예고된 시간 공격을 피하고 정복자의 침공을 저지하라.'},
];
...
const ISSUE_ENV_COLORS = [
 ...
 ['#0a0d14','#2a3446','#8ea6c4'],['#182f39','#6c6a51','#8bc6ba'],['#171625','#594153','#dda45c'],['#241b30','#9d6658','#e7b968'],['#1a303c','#697d80','#7de0c7'],['#151b36','#504363','#b398eb'],['#18232a','#655850','#dba6cb'],['#111b31','#354362','#67d4e6']];
const MISSION_TYPES = [
...
function endgameStage(name){if(name==='타노스 • 인피니티')return 6;const i=ENDGAME_STONES.findIndex(s=>name==='타노스 • '+s.name+' 스톤'||name==='타노스 · '+s.name);return i<0?0:i+1;}

const FFH_NAMES=['샌드맨(엘리멘탈스)','사이클론(엘리멘탈스)','하이드로맨(엘리멘탈스)','몰튼맨(엘리멘탈스)','엘리멘탈스 퓨전','미스테리오(파 프롬 홈)'];
const FFH_FAMS=['ffhEarth','ffhWind','ffhWater','ffhFire','ffhFusion','ffhMysterio'];

const NWH_NAMES=['닥터 옥토퍼스(노 웨이 홈)','그린 고블린(노 웨이 홈)','샌드맨(노 웨이 홈)','리자드(노 웨이 홈)','일렉트로(노 웨이 홈)','노 웨이 홈 · 최종 결전'];
const NWH_FAMS=['nwhOck','nwhGoblin','nwhSand','nwhLizard','nwhElectro','nwhAll'];

const BND_NAMES=['스콜피온','툼스톤','부메랑','진 그레이'];
const BND_FAMS=['bndScorpion','bndTombstone','bndBoomerang','bndJean'];

const KANG_NAMES=['빅터 타임리','라마투트','스칼렛 센추리온','이모터스','정복자 캉'];
const KANG_FAMS=['kangTimely','kangRama','kangScarlet','kangImmortus','kangPrime'];
